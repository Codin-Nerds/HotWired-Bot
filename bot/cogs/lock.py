...
class Lock(Cog):
    ...
    @command()
    async def banlock(self, ctx: Context) -> None:
    ...
    @command()
    async def banunlock(self, ctx: Context) -> None:
    ...
    @command()
    async def kicklock(self, ctx: Context) -> None:
    ...
    @command()
    async def kickunlock(self, ctx: Context) -> None:
